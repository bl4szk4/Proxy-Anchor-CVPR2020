...
parser.add_argument('--dataset',
    default='cub',
    help = 'Training dataset, e.g. cub, cars, SOP, Inshop, logos'
)
parser.add_argument('--data_path', type=str, default='./data',
    help='Path to dataset root folder')   # <-- dodany argument
...
# Directory for Log
LOG_DIR = args.LOG_DIR + '/logs_{}/{}_{}_embedding{}_alpha{}_mrg{}_{}_lr{}_batch{}{}'.format(
    args.dataset, args.model, args.loss, args.sz_embedding, args.alpha,
...
# Ustawienie katalogu z danymi na podstawie argumentu --data_path
...
# Dla zbiorów Inshop i logos użyjemy folderu "test" zamiast "eval"
if args.dataset not in ['Inshop', 'logos']:
